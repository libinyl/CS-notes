...
sudo apt update
sudo apt install -y cmake build-essential gdb vim wget git openssh-server qemu libncurses5-dev gcc-arm-linux-gnueabi gcc-5-arm-linux-gnueabi imagemagick graphviz dvipng librsvg2-bin virtualenv texlive-xetex python3-sphinx screen net-tools tilix
...
vmrun start "/Users/libinyl/Virtual Machines.localized/ubuntu1804.vmwarevm" nogui
```